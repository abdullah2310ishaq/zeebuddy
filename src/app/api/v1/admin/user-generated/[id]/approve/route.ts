...
/**
 * POST /api/v1/admin/user-generated/:id/approve
 * Approves user post and sends push notification to author.
 */
export async function POST(
  ...
  try {
    ...
    return apiSuccess({ message: 'Post approved', post });
  } catch (err) {
    console.error('Approve error:', err);
    return apiError('Failed to approve post', 'SERVER_ERROR', 500);
  }
}
